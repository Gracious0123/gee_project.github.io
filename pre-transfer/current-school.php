...
<head>
    ...
    <title>Current School Information - TeacherMatch</title>
    ...
    <style>
        ...
        .welcome-subtext { color:rgb(233, 235, 238); margin-top: 0.25rem; }
        ...
        .card-modern { max-width: 420px; width: 100%; margin: 2rem auto; border-radius: 18px; box-shadow: 0 4px 24px rgba(44,62,80,0.10); background: #fff; border-top: 6px solid #5B6DCD; display: flex; flex-direction: column; align-items: center; padding: 2.5rem 2rem 2rem 2rem; position: relative; }
        .card-modern .icon-badge { background: #5B6DCD; color: #fff; border-radius: 50%; width: 64px; height: 64px; display: flex; align-items: center; justify-content: center; font-size: 2rem; position: absolute; top: -32px; left: 50%; transform: translateX(-50%); box-shadow: 0 2px 8px rgba(44,62,80,0.10); }
        ...
        .card-modern .card-body strong { color: #5B6DCD; min-width: 120px; display: inline-block; }
        @media (max-width: 600px) { .main-content { margin-left: 0; width: 100%; padding: 1rem; } .sidebar { position: static; width: 100%; height: auto; } .card-modern { padding: 1.5rem 0.5rem 1.5rem 0.5rem; } .card-modern .card-title { font-size: 1.15rem; } }
        .info-cards-grid {
            display: grid;
        ...
        <main class="main-content">
            <header class="header">
                ...
                <div style="text-align: center;">
                    ...
                    <p class="welcome-subtext">Current School Information</p>
                </div>
            ...
            <div style="display: flex; justify-content: center; align-items: center; min-height: 70vh;">
                <div class="card-modern">
                    ...
                    <div class="card-title">Current School Information</div>
                    <div class="card-body">
                        <div class="info-cards-grid">
                            <div class="info-card"><span class="info-icon" style="background: #5B6DCD; color: #fff;"><i class="fas fa-school"></i></span><div><div style="font-size: 0.95rem; color: #404854;">School Name</div><div style="font-weight: 600; color: #25424e;"><?php echo htmlspecialchars($_SESSION['school_name'] ?? 'N/A'); ?></div></div></div>
                            <div class="info-card"><span class="info-icon" style="background: #4FD1C5; color: #fff;"><i class="fas fa-map-marker-alt"></i></span><div><div style="font-size: 0.95rem; color: #404854;">District</div><div style="font-weight: 600; color: #25424e;"><?php echo htmlspecialchars($_SESSION['school_district'] ?? 'N/A'); ?></div></div></div>
                            <div class="info-card"><span class="info-icon" style="background: #68D391; color: #fff;"><i class="fas fa-globe-africa"></i></span><div><div style="font-size: 0.95rem; color:#718096 #404854;">Region</div><div style="font-weight: 600; color: #25424e;"><?php echo htmlspecialchars($_SESSION['school_region'] ?? 'N/A'); ?></div></div></div>
                            <div class="info-card"><span class="info-icon" style="background: #FFB74D; color: #fff;"><i class="fas fa-map"></i></span><div><div style="font-size: 0.95rem; color:#404854;">Address</div><div style="font-weight: 600; color: #25424e;"><?php echo htmlspecialchars($_SESSION['school_address'] ?? 'N/A'); ?></div></div></div>
                            <div class="info-card"><span class="info-icon" style="background: #E57373; color: #fff;"><i class="fas fa-phone"></i></span><div><div style="font-size: 0.95rem; color: ;">Contact</div><div style="font-weight: 600; color: #25424e;"><?php echo htmlspecialchars($_SESSION['school_contact'] ?? 'N/A'); ?></div></div></div>
                            <div class="info-card"><span class="info-icon" style="background: #3ed6c5; color: #fff;"><i class="fas fa-envelope"></i></span><div><div style="font-size: 0.95rem; color: #404854;">Email</div><div style="font-weight: 600; color: #25424e;"><?php echo htmlspecialchars($_SESSION['school_email'] ?? 'N/A'); ?></div></div></div>
                            <div class="info-card"><span class="info-icon" style="background: #4FD1C5; color: #fff;"><i class="fas fa-user-tie"></i></span><div><div style="font-size: 0.95rem; color: #404854;">Principal</div><div style="font-weight: 600; color: #25424e;"><?php echo htmlspecialchars($_SESSION['school_principal'] ?? 'N/A'); ?></div></div></div>
                        </div>
                    </div>
                </div>
            </div>
